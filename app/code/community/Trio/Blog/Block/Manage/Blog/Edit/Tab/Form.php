<?php
class Trio_Blog_Block_Manage_Blog_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm() {
        ...
        $fieldset->addField('banner_content', 'editor', array(
            'name' => 'banner_content',
            'label' => Mage::helper('blog')->__('Post Banner'),
            'title' => Mage::helper('blog')->__('Post Banner'),
