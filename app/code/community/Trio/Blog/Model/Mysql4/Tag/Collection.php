...
class Trio_Blog_Model_Mysql4_Tag_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract {
    ...
    public function getActiveTags() {
        ...
        $this->getSelect()
                ...
                ->joinLeft(array("stores" => $this->getTable('blog/store')), 'main_table.store_id = stores.store_id', array())
                ...
                ->limit(Mage::getStoreConfig(Trio_Blog_Helper_Config::XML_TAGCLOUD_SIZE))
                ->group('tag');
