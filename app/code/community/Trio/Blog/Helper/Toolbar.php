...
class Trio_Blog_Helper_Toolbar extends Mage_Core_Block_Abstract
{
    ...
    { 
        ...
        $block->setChild('trio_blog_comments_toolbar', $toolbar);
    }
    ...
    {
        $block = $this->getToolbarParentBlock()->getLayout()->getBlock('trio_blog_list_toolbar');
