...
class Trio_Ajaxfilter_Block_Ajax extends Mage_Core_Block_Template{
	public function __construct(){
		...
		if($this->loadingImage == '' || $this->loadingImage == null){
			$this->loadingImage = $this->url.'media/wysiwyg/trio/ajaxfilter/default/ajax-loader.gif';
		}else{
			$this->loadingImage = $this->url.'media/wysiwyg/trio/ajaxfilter/default/'.$loadingImage;
		}	
	}
