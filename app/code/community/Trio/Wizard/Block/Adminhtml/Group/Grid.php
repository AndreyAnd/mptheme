...
class Trio_Wizard_Block_Adminhtml_Group_Grid extends Mage_Adminhtml_Block_Widget_Grid {
	...
	protected function _prepareCollection() {
		$collection = Mage::getModel('wizard/group')->getCollection();
	...
	protected function _prepareColumns() {
		...
		$this->addColumn('position', array(
				'header'	=> Mage::helper('wizard')->__('Position'),
				'align'		=> 'left',
				'width'		=> '100px',
				'index'		=> 'position',
				'type'		=> 'options',
				'options'	=> Mage::getSingleton('wizard/config_source_position')->toGridOptionArray(),
		));
	...
	protected function _prepareMassaction() {
		...
		$this->getMassactionBlock()->addItem('delete', array(
				'label'	   => Mage::helper('wizard')->__('Delete'),
