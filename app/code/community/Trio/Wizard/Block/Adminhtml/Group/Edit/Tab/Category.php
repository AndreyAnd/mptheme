...
class Trio_Wizard_Block_Adminhtml_Group_Edit_Tab_Category extends Mage_Adminhtml_Block_Catalog_Category_Tree {
	...
	public function getCategoryChildrenJson($categoryId) {
		...
		return Mage::helper('wizard')->jsonEncode($children);
	}
