...
class Trio_Wizard_Model_Config_Source_Navposition {
	...
	public function getOptions() {
		return array(
			'inside' 			=> 'Inside wizard on both sides',
			'outside' 			=> 'Outside the wizard on both sides',
			'inside-left' 		=> 'Inside wizard grouped left',
			'inside-right' 		=> 'Inside wizard grouped right',
		);
	}
}