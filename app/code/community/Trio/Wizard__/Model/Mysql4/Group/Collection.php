...
class Trio_Flexslider_Model_Mysql4_Group_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract {

	/**
	 * Constructor method
	 */
	protected function _construct() {
		$this->_init('wizard/group');
	}
	 ...
	 * @return Trio_Flexslider_Model_Mysql4_Group_Collection
	 */
	...
	public function addCategoryFilter($category) {
		$this->getSelect()->join(
				array('category_table' => $this->getTable('wizard/wizard_category')),
	...
	public function addPageFilter($page) {
		$this->getSelect()->join(
				array('page_table' => $this->getTable('wizard/wizard_page')),
	...
	public function addStoreFilter($store) {
		if (!Mage::app()->isSingleStoreMode()) {
			...
			$this->getSelect()->join(
					array('store_table' => $this->getTable('wizard/wizard_store')),
