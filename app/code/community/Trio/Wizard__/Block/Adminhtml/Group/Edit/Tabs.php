	...
	protected function _beforeToHtml() {
		...
		if ($this->getRequest()->getParam('id')) {
			$this->addTab('slides_section', array(
				'label'		=> Mage::helper('wizard')->__('Slides of this Group'),
				'title'		=> Mage::helper('wizard')->__('Slides of this Group'),
				'content'	=> $this->getLayout()->createBlock('wizard/adminhtml_group_edit_tab_slides')->toHtml(),
