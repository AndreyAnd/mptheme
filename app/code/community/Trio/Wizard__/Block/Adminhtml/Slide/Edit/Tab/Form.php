...
class Trio_Flexslider_Block_Adminhtml_Slide_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form {
	...
	*/
	protected function _getAdditionalElementTypes() {
		return array(
			'image' => Mage::getConfig()->getBlockClassName('wizard/adminhtml_slide_helper_image')
		);
	}
	...
	protected function _prepareForm() {
		...
		if ($slide = Mage::registry('wizard_slide')) {
