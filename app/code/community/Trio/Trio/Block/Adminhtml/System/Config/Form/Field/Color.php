...
class Trio_Trio_Block_Adminhtml_System_Config_Form_Field_Color extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
		$html = $element->getElementHtml();
		$jsPath = $this->getJsUrl('trio/jquery/jquery-1.7.2.min.js');
		$mcpPath = $this->getJsUrl('trio/jquery/plugins/mcolorpicker/');
