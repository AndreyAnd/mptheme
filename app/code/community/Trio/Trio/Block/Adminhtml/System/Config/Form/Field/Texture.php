...
class Trio_Trio_Block_Adminhtml_System_Config_Form_Field_Texture extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
		$html = $element->getElementHtml();
		$jsUrl = $this->getJsUrl('trio/jquery/jquery-1.7.2.min.js');
		$textureUrl = Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_MEDIA) . Mage::helper('trio')->getTexturePath();
